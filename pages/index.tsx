  ...
  <div>
    ...
    <main>
      ...
      <DiscordMessages>
        <DiscordMessage profile="maximillian">
          Hey, <DiscordMention>Alyx Vargas</DiscordMention> and{" "}
          <DiscordMention>Dawn</DiscordMention>. Welcome to our server! Be sure
          to read through the{" "}
          <DiscordMention type="channel">rules</DiscordMention>. You can ping
          <DiscordMention type="role" color="#70f0b4">
            Support
        ...
        <DiscordMessage author="Alyx Vargas">
          Hey there
          <DiscordMention highlight>Maximillian Osborn</DiscordMention>, thanks!
          I will!
        </DiscordMessage>
      </DiscordMessages>
      ...
      <DiscordMessages>
        <DiscordMessage profile="skyra">
          ...
          >
            ...
            <br />
            <br />
            With a history of many other Discord bot frameworks (both for NodeJS
            and other languages) to inspire Sapphire, it has become the ultimate
            modern experience of writing your code.
      ...
      <DiscordMessages>
        <DiscordMessage profile="discordjs" timestamp="12/06/2021">
          ...
          cookies/service workers you have. For some of you nothing needs to be
          done, for others a so called "hard-refresh" will do the trick too.
          <br />
          <br />
